...
int main(int argc, char **argv){
  ...
  ph.param<std::string>("arm_name", arm_name,std::string("left_arm"));
  ...
  double duration;
  ph.param<double>("planning_duration",duration,15.0);
  ...
  ROS_INFO("[send_move_arm_goal] %s Gripper Goal: %f %f %f %f\n",arm_name.c_str(), gripper_goal_msg.x,gripper_goal_msg.y,gripper_goal_msg.z,gripper_goal_msg.w);
